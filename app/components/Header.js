      ...
      <nav className="navbar navbar-default navbar-static-top">
        <div className="container">
          <div className="navbar-header">
            ...
            <IndexLink to="/" className="navbar-brand">Student Record System</IndexLink>
          </div>
          <div id="navbar" className="navbar-collapse collapse">
            <ul className="nav navbar-nav">
              <li><IndexLink to="/roster" activeStyle={active}>Student Roster</IndexLink></li>
              <li><Link to="/students/new" activeStyle={active}>Register New Student</Link></li>
            </ul>
          </div>
        </div>
      </nav>
